...
run_hespress_spark_job = PythonOperator(
    task_id='run_spark_job_yhespress',
    python_callable=task,
    dag=dag,
)

run_massae_spark_job = PythonOperator(
    task_id='run_spark_job_massae',
    python_callable=task,
    dag=dag,
)

run_yaoum_spark_job = PythonOperator(
    task_id='run_spark_job_yaoum',
    python_callable=task,
    dag=dag,
)
